...
BOOTBLOCK_ASFLAGS += $(GLOBAL_ASFLAGS) $(GLOBAL_CFLAGS)
...
BOOTDECOMP_CFLAGS += $(GLOBAL_CFLAGS) $(LIBGCC_INCLUDE) $(INCLUDES)
...
IMAGEZ_DEP = $(IMAGEZ_INI) $(MAKEBOOTFS) $(BOOTDECOMP) $(KINIT) $(PHLOXK) $(INIT) $(TEST_MAIN)
...
KINIT_CFLAGS += $(GLOBAL_CFLAGS) $(LIBGCC_INCLUDE) $(INCLUDES)
